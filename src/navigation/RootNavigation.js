...
const TABS = [
  ...
  { name: 'Catalog', label: 'Catalog', icon: ShoppingBag,  component: KatalogScreen },
          ...
          >
            {focused ? (
              <View style={styles.activeNavItem}>
                ...
                <Text style={styles.activeNavText} numberOfLines={1}>{label}</Text>
              </View>
            ) : (
...
const styles = StyleSheet.create({
  tabBar: {
    ...
    elevation: 10,
    alignItems: 'center',
    paddingHorizontal: 12,  // jarak dari pinggir layar agar pill tidak terpotong
  },
  tabButton: {
    flex: 1,
    height: '100%',
  ...
  activeNavItem: {
    ...
    paddingVertical: 9,
    gap: 3,
    width: '70%',        // tidak melebihi lebar tab button
  },
  activeNavText: {
    fontSize: 11,
    color: '#FFFFFF',
